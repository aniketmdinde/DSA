...
public:
    ...
    {
        // If key in not found, create new node and return
        // else return existing node's value
        ...
        if (valueFound == NULL)
        {
            ...
            // Search again and return the bucket
            valueFound = search(key); // address of value since search returns a T*
        }

        return *valueFound; // derefencing to access the value whose address will be returned
        // Since returning value by reference
    }
};
...
int main()
{
    ...
    h["newFruit"] = 300;
    cout << "newFruit Cost: " << h["newFruit"] << endl;
    ...
    h["newFruit"] += 20;
    cout << "newFruit Updated cost: " << h["newFruit"] << endl;
